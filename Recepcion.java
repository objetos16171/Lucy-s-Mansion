...
class Recepcion extends Escenario
{
    ...
    private void iniciaPuertas()
    {
        ...
        puertasRecepcion[0] = new Puerta(2, 0); //Puerta 0, que va al pasillo 1, se requieren 0 llaves para entrar
        puertasRecepcion[1] = new Puerta(2, 2);  //Puerta 1, que va al pasillo 2, se requieren 2 llaves para entrar
        puertasRecepcion[2] = new Puerta(2, 2);  //Puerta 2, que va al pasillo 3, escalera, no sube hasta ser nivel 2
        puertasRecepcion[3] = new Puerta(3, 1);  //Puerta 3, que va al cuarto 2, requiere nivel 1 para entrar
        puertasRecepcion[4] = new Puerta(5, 1);  //Puerta 4, que va al cuarto de recuperacion, requiere nivel 1 para entrar
